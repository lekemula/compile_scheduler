...
GreedyConstructor::GreedyConstructor(shared_ptr<CostFunction> costFunction) { this->_costFunction = costFunction; }

int GreedyConstructor::_incrementalCost(CompilationStep& candidate) { return (*_costFunction)(candidate.sourceFile); }
